  ...
  return (
    <div className="min-h-screen bg-white flex flex-col items-center justify-center px-4">
      ...
      <div className="card w-full max-w-sm">
        <h1 className="text-lg font-semibold text-gray-900 mb-1">Patient sign in</h1>
        <p className="text-sm text-gray-500 mb-5">Welcome back — your queue is waiting.</p>
        ...
        <p className="text-center text-xs text-gray-400 mt-4">
          No account? <Link href="/auth/patient/signup" style={{ color: '#0F5C4D' }} className="font-medium">Sign up</Link>
        </p>
      </div>
    </div>
  )
